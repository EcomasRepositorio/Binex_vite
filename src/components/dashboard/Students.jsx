...
/*
  ...
  useEffect(() => {
    ...
    fetch("https://binex.edu.pe:6000/server/students")
  ...
  const handleAddStudent = (newStudentData) => {
    if (selectedStudent && selectedStudent.id_estudiante) {
      handleHttpAction(
        `https://binex.edu.pe:6000/server/students/update/${selectedStudent.id_estudiante}`,
        "PUT",
        newStudentData
      );
      ...
      handleHttpAction(
        "https://binex.edu.pe:6000/server/students/save",
        "POST",
        newStudentData
      );
  ...
  const handleDeleteStudent = (studentCodigo) => {
    ...
    handleHttpAction(
      `https://binex.edu.pe:6000/server/students/delete/${studentCodigo}`,
      "DELETE"
    );
