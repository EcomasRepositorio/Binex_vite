...
export const Students = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://binex.edu.pe:4500/server/students")
  ...
  const handleAddStudent = (newStudentData) => {
    if (selectedStudent && selectedStudent.id_estudiante) {
      handleHttpAction(
        `https://binex.edu.pe:4500/server/students/update/${selectedStudent.id_estudiante}`,
        "PUT",
        newStudentData
      );
      ...
      handleHttpAction(
        "https://binex.edu.pe:4500/server/students/save",
        "POST",
        newStudentData
      );
  ...
  const handleDeleteStudent = (studentCodigo) => {
    ...
    handleHttpAction(
      `https://binex.edu.pe:4500/server/students/delete/${studentCodigo}`,
      "DELETE"
    );
