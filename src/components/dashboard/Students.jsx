...
/*
  ...
  useEffect(() => {
    ...
    fetch("https://binex.edu.pe/server/students")
  ...
  const handleAddStudent = (newStudentData) => {
    if (selectedStudent && selectedStudent.id_estudiante) {
      handleHttpAction(
        `https://binex.edu.pe/server/students/update/${selectedStudent.id_estudiante}`,
        "PUT",
        newStudentData
      );
      ...
      handleHttpAction(
        "https://binex.edu.pe/server/students/save",
        "POST",
        newStudentData
      );
  ...
  const handleDeleteStudent = (studentCodigo) => {
    ...
    handleHttpAction(
      `https://binex.edu.pe/server/students/delete/${studentCodigo}`,
      "DELETE"
    );
